...
- 图像存储位置
  ...
  ![](https://assets.ng-tech.icu/book/Python-100-Days/相对路径.png)
...
- 字符实体（实体替换符）
  ...
  ![](https://assets.ng-tech.icu/book/Python-100-Days/字符实体.png)
...
- 规则、属性和值
  ...
  ![](https://assets.ng-tech.icu/book/Python-100-Days/选择器语法.png)

- 常用选择器

  ![](https://assets.ng-tech.icu/book/Python-100-Days/常用选择器.png)
...
- 文本的大小和字型(font-size / font-family)
  ...
  ![](https://assets.ng-tech.icu/book/Python-100-Days/尺寸单位.png)

  ![](https://assets.ng-tech.icu/book/Python-100-Days/衬线字体+非衬线字体+等宽字体.png)

- 粗细、样式、拉伸和装饰(font-weight / font-style / font-stretch / text-decoration)

  ![](https://assets.ng-tech.icu/book/Python-100-Days/字体样式.png)
...
- 盒子的边框、外边距和内边距（border / margin / padding）
  ...
  ![](https://assets.ng-tech.icu/book/Python-100-Days/盒子模型.png)
...
- 网站布局
  ...
  - HTML5 布局
    ...
    ![](https://assets.ng-tech.icu/book/Python-100-Days/经典布局-2.png)
...
![](https://assets.ng-tech.icu/book/Python-100-Days/baidu_echarts.png)
...
3. 可视化
   ...
   ![](https://assets.ng-tech.icu/book/Python-100-Days/bootstrap-layoutit.png)
