...
1. [注册域名](https://wanwang.aliyun.com/domain/)。
   ...
   ![](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/Python-100-Days/aliyun-domain.png)

2. [域名备案](https://beian.aliyun.com/)。

   ![](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/Python-100-Days/aliyun-keeprecord.png)

3. [域名解析](https://dns.console.aliyun.com/#/dns/domainList)。

   ![](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/Python-100-Days/aliyun-dnslist.png)

   ![](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/Python-100-Days/aliyun-resolve-settings.png)

4. [购买证书](https://www.aliyun.com/product/cas)。

   ![](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/Python-100-Days/aliyun-certificate.png)
...
> **提示**：还有一个和 Supervisor 功能类似的工具名为 Circus，支持 Python 3。
