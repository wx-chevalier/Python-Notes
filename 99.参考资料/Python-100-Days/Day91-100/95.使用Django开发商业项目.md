...
![](https://assets.ng-tech.icu/book/Python-100-Days/django_request_response_cycle.png)
...
5. XFrameOptionsMiddleware - 防范点击劫持攻击中间件
   ...
   ![](https://assets.ng-tech.icu/book/Python-100-Days/click-jacking.png)

![](https://assets.ng-tech.icu/book/Python-100-Days/builtin-middlewares.png)
...
djangorestframework 提供了基于 Bootstrap 定制的页面来显示接口返回的 JSON 数据，当然也可以使用[POSTMAN](https://www.getpostman.com/)这样的工具对 API 接口进行测试。
...
1. RBAC - 基于角色的访问控制，如下图所示。
   ...
   ![](https://assets.ng-tech.icu/book/Python-100-Days/rbac-basic.png)

   ![](https://assets.ng-tech.icu/book/Python-100-Days/rbac-full.png)
...
![](https://assets.ng-tech.icu/book/Python-100-Days/celery_architecture.png)
...
- Selenium IDE：嵌入到浏览器的插件，可以录制和回放脚本。
  ...
  ![](https://assets.ng-tech.icu/book/Python-100-Days/selenium_ide.png)
...
1. 测试 Django 视图 - Django 中提供的`TestCase`扩展了`unittest`中的`TestCase`，绑定了一个名为`client`的属性，可以用来模拟浏览器发出的 GET、POST、DELETE、PUT 等请求。
