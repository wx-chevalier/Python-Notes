...
![](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/Python-100-Days/git-logo.png)
...
![](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/Python-100-Days/git_repository.png)
...
> **提示**：可以用`git config --list`来查看 Git 的配置信息。
...
![](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/Python-100-Days/gitlab-about.png)
...
1. 创建项目时不建议勾选如下图所示的这些选项，编程语言可以暂时不做选择，而`.gitignore`模板也可以稍后自己编写或者通过更专业的工具（如：<http://gitignore.io/>网站）自动生成。
   ...
   ![](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/Python-100-Days/gitee-create-project.png)

2. 添加项目成员。创建项目后，可以在项目的“设置”或“管理”中找到“成员管理”功能，这样就可以将其他开发者设置为项目团队的成员，项目成员通常分为“所有者”、“管理者”、“普通成员”和“受限成员”几种角色。

   ![](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/Python-100-Days/gitee-add-members.png)
...
![](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/Python-100-Days/gitee-project-index.png)
...
4. 分支**变基**。分支合并操作可以将多个分支上的工作成果最终合并到一个分支上，但是再多次合并操作之后，分支可能会变得非常的混乱和复杂，为了解决这个问题，可以使用`git rebase`操作来实现分支变基。如下图所示，当我们希望将`master`和`dev`上的工作成果统一到一起的时候，也可以使用变基操作。
   ...
   ![](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/Python-100-Days/git-rebase.png)
...
4. `git reset`：回退到指定的版本。该命令主要有三个参数，如下图所示。
   ...
   ![](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/Python-100-Days/git-reset.png)
...
5. 在线发起一次合并请求（通常称之为**Pull Request**，有的地方称为**Merge Request**），请求将自己的工作成果合并到`master`分支，合并之后可以删除该分支。
   ...
   ![](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/Python-100-Days/gitee-pull-request.png)
...
![](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/Python-100-Days/git-flow.png)
...
![](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/Python-100-Days/git-flow-detail.png)
...
![](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/Python-100-Days/zentao-login.png)

第一次使用禅道时，建议通过点击用户名，然后通过“帮助”菜单的“新手教程”来迅速了解禅道。官方网站的文档链接中提供了[视频教程](https://www.zentao.net/video/c1454.html)，初学者也可以通过视频教程来上手。

![](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/Python-100-Days/zentao-index.png)
...
![](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/Python-100-Days/gitlab-new-issue.png)
...
![](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/Python-100-Days/jenkins_new_project.png)
