...
![](https://assets.ng-tech.icu/book/Python-100-Days/pycharm-vote-project.png)
...
3. 运行项目，在浏览器中访问`http://127.0.0.1:8000/admin`，输入刚才创建的超级用户账号和密码进行登录。
   ...
   ![](https://assets.ng-tech.icu/book/Python-100-Days/django-admin-apps.png)
...
4. 注册模型类。
   ...
   ![](https://assets.ng-tech.icu/book/Python-100-Days/django-admin-models.png)
...
5. 对模型进行 CRUD 操作。
   ...
   - 添加学科。
     ...
     ![](https://assets.ng-tech.icu/book/Python-100-Days/django-admin-add-model.png)

   - 查看所有学科。

     ![](https://assets.ng-tech.icu/book/Python-100-Days/django-admin-view-models.png)

   - 删除和更新学科。

     ![](https://assets.ng-tech.icu/book/Python-100-Days/django-admin-delete-update-model.png)
...
6. 注册模型管理类。
   ...
   ![](https://assets.ng-tech.icu/book/Python-100-Days/django-admin-view-models-subject.png)

   ![](https://assets.ng-tech.icu/book/Python-100-Days/django-admin-view-models-teacher.png)
