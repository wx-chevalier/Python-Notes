...
![](https://assets.ng-tech.icu/book/Python-100-Days/web-application.png)
...
![](https://assets.ng-tech.icu/book/Python-100-Days/http-request.png)

HTTP 响应（响应行+响应头+空行+消息体）：

![](https://assets.ng-tech.icu/book/Python-100-Days/http-response.png)
...
![](https://assets.ng-tech.icu/book/Python-100-Days/mvc.png)
...
4. 用 PyCharm 打开创建好的 Djang 项目，并为其添加虚拟环境。

   ![](https://assets.ng-tech.icu/book/Python-100-Days/pycharm-django-project.png)
...
5. 安装项目依赖项。
   ...
   ![](https://assets.ng-tech.icu/book/Python-100-Days/pycharm-install-django.png)
...
6. 启动 Django 自带的服务器运行项目。
   ...
   方法一：在“Run”菜单选择“Edit Configuration”，配置“Django server”运行项目（适用于专业版 PyCharm）。

   ![](https://assets.ng-tech.icu/book/Python-100-Days/pycharm-django-server.png)

   方法二：在“Run”菜单选择“Edit Configuration”，配置运行“Python”程序运行项目（适用于专业版和社区版 PyCharm）。

   ![](https://assets.ng-tech.icu/book/Python-100-Days/pycharm-python-manage.png)
...
![](https://assets.ng-tech.icu/book/Python-100-Days/django-index-1.png)
...
![](https://assets.ng-tech.icu/book/Python-100-Days/django-index-2.png)
...
1. 在项目目录下创建名为 templates 文件夹。
   ...
   ![](https://assets.ng-tech.icu/book/Python-100-Days/pycharm-django-template.png)
