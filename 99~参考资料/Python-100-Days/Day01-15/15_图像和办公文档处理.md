...
![](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/Python-100-Days/image-show.png)
...
1. 剪裁图像
   ...
   ![](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/Python-100-Days/image-crop.png)
...
2. 生成缩略图
   ...
   ![](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/Python-100-Days/image-thumbnail.png)
...
3. 缩放和黏贴图像
   ...
   ![](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/Python-100-Days/image-paste.png)
...
4. 旋转和翻转
   ...
   ![](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/Python-100-Days/image-rotate.png)

   ![](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/Python-100-Days/image-transpose.png)
...
5. 操作像素
   ...
   ![](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/Python-100-Days/image-putpixel.png)
...
6. 滤镜效果
   ...
   ![](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/Python-100-Days/image-filter.png)
